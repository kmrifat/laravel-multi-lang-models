                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            @foreach((new \App\Helpers\LocalizationHelper())->getAllLanguages() as $key=>$lang)
                                <a class="dropdown-item" href="{{ route('change-lang',[$lang]) }}">{{ $lang }}</a>
                            @endforeach
                        </div>
                    </li>
                </ul>
            ...
            @foreach($blogs as $blog)
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        {{ \Illuminate\Support\Str::limit($blog->getLang->description,'120', ' ...') }} <br>
                        <a href="{{ route('read-blog', $blog->id) }}" class="btn btn-link">Read More</a>
